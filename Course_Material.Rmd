...
In R objects are assigned values using the `<-` symbol. A shortcut for this is `ALT + "-"`.
```{r assignment}
...
Check out the R [self-learning guide](https://kai-data-exploitation.github.io/R-selflearn-guide/guide.html) for a curated guide to the most useful R packages
